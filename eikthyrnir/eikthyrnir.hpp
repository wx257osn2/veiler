//Copyright (C) 2012-2017, 2021 I
//  Distributed under the Boost Software License, Version 1.0.
//  (See accompanying file LICENSE.txt or copy at http://www.boost.org/LICENSE_1_0.txt)

#ifndef VEILER_EIKTHYRNIR_EIKTHYRNIR_HPP_INCLUDED
#define VEILER_EIKTHYRNIR_EIKTHYRNIR_HPP_INCLUDED
...
template<typename T = detail::expected::holder, typename E = std::exception_ptr>using expected = veiler::expected<T, E>;
...
#endif//VEILER_EIKTHYRNIR_EIKTHYRNIR_HPP_INCLUDED
